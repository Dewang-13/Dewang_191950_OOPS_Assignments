/* Experiment - 6
AIM - Write a class String that can be used to store strings, add strings, equate string, output strings.
THEORY - Strings are objects that represent sequences of characters.*/
